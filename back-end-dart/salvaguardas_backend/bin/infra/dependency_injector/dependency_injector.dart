...
class DependencyInjector {
  ...
  void register<T extends Object>(
    ...
    bool isSigleton = true,
  }) =>
      _instanceMap[T] = _InstanceGenerator(instance, isSigleton);
...
class _InstanceGenerator<T> {
  ...
  _InstanceGenerator(this._instanceCreator, bool isSigleton)
      : _isFirstGet = isSigleton;
